...
<p>Right now there are a few things people can do to help development.  The first
...
the <a href="/tl880spy.html">TL880Spy tool</a> in Windows that allows "playing" with the
...
<a href="#synctest">OSD, cursor, sync test</a>.  Neither test would have the
...
<a href="/testcd.html">bootable test disc</a>, or -->from an installed Linux
...
<a name="synctest"></a><h4>OSD, Cursor, and Video Sync Test</h4>
...
passthrough feature of the HDTV card will be sufficient.  The chip also has a
powerful OSD mechanism and support for mouse cursor overlays.  This test will
display color bars, a test OSD image, and a mouse cursor.  It may also be
helpful to include your dmesg output with the results of this test.
...
<table width="80%" align="center" border="0" cellspacing="15" cellpadding="0">
	...
	<tr>
		<td><tt>$ tools/osd.sh; tools/dpc/videoout 0</tt></td>
		<td><i>Run the display tests</i></tt>
	</tr>
	<tr>
		<td><tt># rmmod tl880</tt></td>
		<td><i>Unload the driver from the kernel</i></td>
	...
	<tr>
		<td colspan="2"><tt><font size="-1">
Subject: Driver display test results (example)<br>
The display showed color bars at 60.0Hz vertical (48.3kHz horizontal)<br>
refresh rate for eight seconds, then showed an animated mouse cursor.<br>
Finally, original video output was restored.<br>
<br>
.
		</font></tt></td>
	</tr>
