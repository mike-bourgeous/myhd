...
loc_32D19:
	...
	if(1 /* audio_mode == 0 */) {
		tl880_write_register(tl880dev, 0x3034, 0x1000); /* 1000 used as base */
		tl880_write_register(tl880dev, 0x303c, 0x87fc); /* base + 77fc */
		tl880_write_register(tl880dev, 0x3038, 0x1000);
	} else {
		tl880_write_register(tl880dev, 0x304c, 0x1000);
		tl880_write_register(tl880dev, 0x3054, 0x87fc);
		tl880_write_register(tl880dev, 0x3038, 0x1000);
	}
}
